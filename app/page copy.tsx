...
export default function YearbookPickerPage() {
  ...
  return (
    <div className="w-screen min-h-screen flex justify-center items-start bg-gradient-to-b from-white to-zinc-50 p-6">
      {/* Rounded-page container */}
      <div
        className="w-full max-w-[1200px] bg-white rounded-3xl overflow-hidden border-2 shadow-lg"
        style={{ borderColor: ivyGreen }}
      >
        {/* Main content row */}
        <div
          className="flex flex-col md:flex-row w-full p-6"
          style={{ gap: `${baseGap}px` }}
        >
                ...
                {selected ? (
                  <div className="flex flex-col items-center justify-center h-full space-y-3">
                    ...
                    <button
                      ...
                      onClick={() => alert(`Photo ${selected} confirmed!`)}
                    >
                      Confirm
                    </button>
                  </div>
